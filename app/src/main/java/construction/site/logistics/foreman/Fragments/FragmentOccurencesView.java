...
public class FragmentOccurencesView extends Fragment {
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        getActivity().setTitle(getResources().getString(R.string.fragment_occurrences_view_title));

        continue_btn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                if (ocurrencesAdapter == null){
                ...
                if(!selected){
                    ...
                    Fragment fragment = new FragmentOccurencesAdd();
    ...
    private void LoadOccurences(){
        ...
        queue.setTitle( getResources().getString(R.string.fragment_occurrences_view_title));
        queue.setDescription( getResources().getString(R.string.fragment_occurrences_view_description));
        ...
        try {
            ...
            if (jsonObject.getString("error").equals("false")) {
                ...
                for (int i = 0; i < test; i++) {
                    ...
                    record.setRecord1(dataobj.getString("notas"));
