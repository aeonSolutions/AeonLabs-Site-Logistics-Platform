...
elseif($tablets[0][1]=='0'): // tablet is disabled 
	...
	if($enc[0][0]<>'' or $encGeral[0][0]<>""): // encarregado found on DB
		...
		$sites=$db->getquery("select site_section.cod_site, site.name, site_section.latitude, site_section.longitude, site_section.authentication_radius, site_section.cod_section from site_section left join site on site_section.cod_site=site.cod_site");
		$pos=-1;
