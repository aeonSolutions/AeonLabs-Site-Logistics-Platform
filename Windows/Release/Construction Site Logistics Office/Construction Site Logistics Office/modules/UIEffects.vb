Module UIEffects
    ...
    Private Sub _DropClickSearchBox()
        control.Invoke(Sub()
                           control.Image = Image.FromFile(MainMdiForm.state.imagesPath & Convert.ToString("searchiconClicked.png"))
                           Threading.Thread.Sleep(400)
                           control.Image = Image.FromFile(MainMdiForm.state.imagesPath & Convert.ToString("searchicon.png"))
                       End Sub)
    End Sub
    ...
    Private Sub _DropClickMenu()
        control.Invoke(Sub()
                           control.Image = Image.FromFile(MainMdiForm.state.imagesPath & Convert.ToString("Menu_48px.clicked.png"))
                           Threading.Thread.Sleep(400)
                           control.Image = Image.FromFile(MainMdiForm.state.imagesPath & Convert.ToString("Menu_48px.png"))
                       End Sub)
    End Sub
    ...
    Private Sub _DropClickUpdate()
        control.Invoke(Sub()
                           control.Image = Image.FromFile(MainMdiForm.state.imagesPath & Convert.ToString("refreshClicked.png"))
                           Threading.Thread.Sleep(400)
                           control.Image = Image.FromFile(MainMdiForm.state.imagesPath & Convert.ToString("refresh.png"))
                       End Sub)
    End Sub
    ...
    Private Sub _DropClickMaximize()
        control.Invoke(Sub()
                           control.Image = Image.FromFile(MainMdiForm.state.imagesPath & Convert.ToString("Maximize Window_2 48px.clicked.png"))
                           Threading.Thread.Sleep(400)
                           control.Image = Image.FromFile(MainMdiForm.state.imagesPath & Convert.ToString("Maximize Window_2 48px.png"))
                       End Sub)
    End Sub
    ...
    Private Sub _DropClickMinimize()
        control.Invoke(Sub()
                           control.Image = Image.FromFile(MainMdiForm.state.imagesPath & Convert.ToString("Minimize Window_2 48px.clicked.png"))
                           Threading.Thread.Sleep(400)
                           control.Image = Image.FromFile(MainMdiForm.state.imagesPath & Convert.ToString("Minimize Window_2 48px.png"))
                       End Sub)
    End Sub
    ...
    Private Sub _DropClickRestore()
        control.Invoke(Sub()
                           control.Image = Image.FromFile(MainMdiForm.state.imagesPath & Convert.ToString("Restore Window 2_48px.clicked.png"))
                           Threading.Thread.Sleep(400)
                           control.Image = Image.FromFile(MainMdiForm.state.imagesPath & Convert.ToString("Restore Window 2_48px.png"))
                       End Sub)
    End Sub
