...
Public Module Strings
    Function EncodeString(ByRef SourceData As String, ByRef CharSet As String) As String
    ...
    Function AddSpaces(str As String, numChars As Integer) As String
    ...
    Function randomString(ByVal Optional size = Nothing)
        Dim r As New Random
