...
Public Class siteDataRequests
    ...
    Public Function loadSiteInitialData(vars As Dictionary(Of String, String), Optional taskIni As String = "") As Boolean Implements IDataSiteRequests.loadSiteInitialData
