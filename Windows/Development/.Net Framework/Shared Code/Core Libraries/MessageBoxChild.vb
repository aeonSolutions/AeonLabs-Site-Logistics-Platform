...
Public Class MessageBoxChild
    ...
    Protected Overloads Overrides ReadOnly Property CreateParams() As CreateParams
        ...
        End Get
    End Property
    Public Sub New(_message As String, _title As String, _buttons As MessageBoxButtons, _icon As MessageBoxIcon, ByVal Optional posx As Integer = -1, ByVal Optional posy As Integer = -1, ByVal Optional _state As environmentVarsCore = Nothing)
        ...
        PanelMessage.Height = (ContinueBtn.Location.Y - title.Location.Y)
    End Sub
    ...
    Private Sub message_box_frm_load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        privateFonts.AddFontFile(enVars.fontsPath & enVars.fontTitleFile)

        title.Text = titleMsg
        Dim fontToMeasure As New Font(privateFonts.Families(0), enVars.DialogTitleFontSize, Drawing.FontStyle.Regular)
        ...
        fontToMeasure = New Font(privateFonts.Families(0), enVars.RegularTextFontSize, Drawing.FontStyle.Regular)
        ...
        Dim rm As New ResourceManager("strings", GetType(MessageBoxChild).Assembly)
        ...
        ElseIf buttons.Equals(MessageBoxButtons.OKCancel) Then
            ContinueBtn.Text =
            ContinueBtn.Visible = True
            cancelBtn.Text = "cancel" 'rm.GetString("cancel")
            cancelBtn.Visible = True
        ElseIf buttons.Equals(MessageBoxButtons.YesNo) Then
            ContinueBtn.Text = "Yes" 'rm.GetString("yes")
            ContinueBtn.Visible = True
            cancelBtn.Text = "no" 'rm.GetString("no")
            cancelBtn.Visible = True
        ElseIf buttons.Equals(MessageBoxButtons.RetryCancel) Then
            ContinueBtn.Text = "retry" 'rm.GetString("retry")
            ContinueBtn.Visible = True
            cancelBtn.Text = "Cancel" ' rm.GetString("cancel")
            cancelBtn.Visible = True
        End If
